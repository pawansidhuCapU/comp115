...
def convert_american_dollars(american_dollars):
    ...
    canadian_dollars = american_dollars*conversion_rate
...
# Write and pass your units tests (5 marks)
assert find_max([1,5,3,7,2])==7
assert find_max([10,20,15,30])==30
...
assert sum_of_squares([0,1,2,3])==14
...
assert squares([0,1,2,3])==[0,1,4,9]
assert squares([])==[]

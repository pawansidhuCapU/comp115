...
def test_remove_duplicates_set():
    assert remove_duplicates_set("abcdefg") == "abcdefg"
...
def test_students_id():
    ...
    assert students_id(['002','002','002','002']) == 1
...
# Your unit tests
def test_students_id_occurences():
    ...
    assert students_id_occurrences(['002','002','002','002']) == {'002':4}
    assert students_id_occurrences([]) == {}

test_students_id_occurences()
